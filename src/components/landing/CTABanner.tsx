  ...
  return (
    <section className="container-page pb-16">
      <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-brand-600 to-brand-800 px-8 py-14 text-center text-white">
        ...
        <h3 className="relative text-2xl font-black sm:text-3xl">
          {locale === 'id' ? 'Siap memulai petualangan seru?' : 'Ready to start a fun adventure?'}
        </h3>
        <p className="relative mx-auto mt-3 max-w-lg text-brand-100">
          {locale === 'id'
            ? 'Bergabunglah dengan AXTO sekarang dan temukan dunia cerita tanpa batas.'
            : 'Join AXTO now and discover a world of unlimited stories.'}
        </p>
        <Link
          href="/register"
        ...
        >
          {locale === 'id' ? 'Mulai Gratis Sekarang' : 'Start Free Now'}
        </Link>
      </div>
    </section>
  );
