...
(function (global) {
  ...
  var CAPTIONS = [
    ...
    [15.6, 19.2, 'Keduanya masuk balok start. Suasana hening.'],
    [19.4, 21.2, 'Bersedia … siap …'],
    [21.4, 24.2, 'Astaga! NO NAME lari sebelum aba-aba!'],
    [24.4, 30.4, 'Ia mencuri start! Pistol baru berbunyi sekarang — JOFA baru berangkat!'],
    ...
    [117.0, 122.2, 'JOFA tidak menoleh sedikit pun. Matanya lurus ke depan!'],
